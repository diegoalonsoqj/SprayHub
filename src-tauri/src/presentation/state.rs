...
use crate::application::use_cases::{
    ApplySpray, CreateSpray, DetectSteam, ManageConfig, ScanSprays,
};
use crate::domain::error::AppResult;
use crate::infrastructure::config::JsonConfigRepository;
use crate::infrastructure::filesystem::{FsSprayApplier, FsSprayRepository, FsSprayWriter};
...
impl AppState {
    ...
    pub fn bootstrap() -> AppResult<Self> {
        ...
        let writer = Arc::new(FsSprayWriter::new());
        ...
        Ok(Self {
            ...
            create: Arc::new(CreateSpray::new(writer)),
        })
    }
}
